...
class ApcarrentalsearchModuleFrontController extends ModuleFrontController
{
    public $php_self;
    ...
    {
        if (Tools::getIsset('apcarrental_location') &&
            Tools::getIsset('apcarrental_from') &&
            Tools::getIsset('apcarrental_to')
        ) {
            $results = new ApcarrentalProduct();
            $results = $results->searchProduct(
                Tools::getValue('apcarrental_location'),
                Tools::getValue('apcarrental_from'),
                Tools::getValue('apcarrental_to'),
        ...
        $this->setTemplate('module:apcarrental/views/templates/front/resuilt_search.tpl');
        parent::initContent();
    }
