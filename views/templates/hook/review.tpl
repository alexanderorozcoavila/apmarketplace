...
{if ($nbReviews_product_extra == 0 && $too_early_extra == false && $customer.is_logged) || ($nbReviews_product_extra != 0)}
	<div id="leo_product_reviews_block_extra" class="no-print" {if $nbReviews_product_extra != 0}itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating"{/if}>
		{if $nbReviews_product_extra != 0}
			<div class="reviews_note clearfix">
				...
				<span>{l s='Rating' mod='apmarketplace'}&nbsp;</span>
			...
			{if $nbReviews_product_extra != 0}
				<li>
					<a href="javascript:void(0)" class="read-review">					
						...
						{l s='Read reviews' mod='apmarketplace'} (<span itemprop="reviewCount">{$nbReviews_product_extra}</span>)
					</a>
				</li>
			{/if}
