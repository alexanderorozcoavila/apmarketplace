		...
		<div class="row">
			<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
				...
				<div class="form-group row">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						{foreach from=$langs item=lang}
							<input {if $lang.id_lang != $id_lang}style="display:none;"{/if} {if $lang.id_lang != $id_lang}style="display:none;"{/if} class="lang-lang form-control lang_{$lang.id_lang}" type="text" name="product_name[{$lang.id_lang}]" value="">
						{/foreach}
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<div class="leo-product-image">
							...
							<a href="#" class="btn btn-primary btn-sm add_image"><i class="material-icons">&#xE145;</i> {l s='Add more image' mod='apmarketplace'}</a>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						{foreach from=$langs item=lang}
							<div {if $lang.id_lang != $id_lang}style="display:none;"{/if} class="lang-lang lang_{$lang.id_lang}">
								<textarea  class="autoload_rte" name="product_short[{$lang.id_lang}]" rows="5"></textarea>
							</div>
						{/foreach}
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
				...
				<div class="form-group row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<input type="text" name="product_reference" class="form-control" required="">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-md-12 col-sm-12 col-xs-12 text-xs-left text-md-right form-control-label">
							...
							<li data-depth="{$depth}" class="{if $node.children}has-child{/if}">
								{if $depth===0}
									<div class="leo-categories clearfix">
										...
										{/if}
										<input class="categories_id category_box" id="categories_{$node.id}" type="checkbox" name="categories[]" value="{$node.id}">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="leo-categories-select">
							<div class="categories-tree-actions clearfix">
								...
								<span class="product_catalog_category_tree_title float-xs-right" href="#">{l s='Main Category' mod='apmarketplace'}</span>
							</div>
								...
								<ul class="category-top-menu">
									<li class="{if count($categories.children) > 0}has-child{/if}">
										<div class="leo-categories clearfix">
											...
											<input checked="checked" class="categories_id category_box" id="categories_{$categories.id}" type="checkbox" name="categories[]" value="{$categories.id}">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="add_product">
					<button class="btn btn-primary" type="submit" name="add_product">
						<i class="material-icons">&#xE145;</i>
						{l s='Add Product' mod='apmarketplace'}
					</button>
				</div>
			</div>
		</div>
